export type NormalizedTzPhone = `255${string}`;

export function normalizeTzPhone(raw: string): NormalizedTzPhone | null {
  ...
  return `255${local}` as NormalizedTzPhone;
}

export function formatTzPhoneDisplay(normalized: string) {
